...
$members = [
    [
        ...
        "quote" => '"My responsibility as a documenter lies heavily upon reporting the general accomplishments of our group on a given period and then translating those reports into formal written conclusions or generalizations. I was tasked on completing the Chapter 1 to 3 of our thesis that presents all the vital information and necessary background on why we are conducting a study about it in the first place. I believe that being a voracious reader, detailed and a perfectionist are among the traits that a good documenter should have in order to successfully carry out the task of forming coherent thoughts, reasonable explanations and timely conclusions about the development and implementation of the proposed system at hand."'
    ],
    [
